...
from .modules import authorize, animequotes, admin, cancel_mirror, cat, clone, count, delete, fun, eval, extrahelp, google, list, leech_settings, jav, jav_strings, mediainfo, mirror, mirror_status, nsfw, nsfwhelp, nhentai, paste, shell, speedtest, stickers, sitesearch, songs, telegraph, text, tts, trt, torrent_search, usage, watch, wife, weebify, whois
