...
from .modules import authorize, animequotes, cancel_mirror, cat, clone, count, countdown, delete, fun, eval, extrahelp, google, github, list, leech_settings, jav, jav_strings, lyric, report, mediainfo, mirror, mirror_status, misc, movie, nsfw, nsfwhelp, nhentai, paste, shell, speedtest, stickers, sitesearch, songs, telegraph, hack, text, tts, trt, torrent_search, usage, watch, wife, git, welcome, weebify, whois
